...
No cargo and no network — ``Workspace`` objects are built directly. That the fork actually builds is
covered by an expensive test that lands with the rest of the munge vocabulary.
"""
