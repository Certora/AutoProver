            ...
            "components": [
                {
                    ...
                    "description": "Creating a user's vault PDA and moving lamports in and out of it.",
                    "instructions": ["initialize", "deposit", "withdraw"],
                    "account_types": ["Vault"],
                    "interactions": [],
                    "requirements": [
                        "The implementation must only let the recorded authority withdraw.",
                        "The implementation must keep `balance` equal to the PDA's lamports above rent.",
                    ],
                }
            ],
        }
